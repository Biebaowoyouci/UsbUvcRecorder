...
public class Format implements Parcelable, Cloneable {
     ...
     */
    public int type;
    /** UVC bmInterlaceFlags from the format descriptor. Bit 0 marks interlaced video. */
    ...
    public Format(int index, int type, List<Descriptor> frameDescriptors) {
        this(index, type, 0, frameDescriptors);
    }

    public Format(int index, int type, int interlaceFlags,
                  List<Descriptor> frameDescriptors) {
        this.index = index;
        this.type = type;
        this.interlaceFlags = interlaceFlags;
    ...
    public Format clone() {
        ...
        if (format == null) {
            format = new Format(index, type, interlaceFlags, new ArrayList<>());
        }
